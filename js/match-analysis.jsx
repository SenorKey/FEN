    ...
    <div style={{ marginBottom: 10 }}>
      {label && (
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 4 }}>
          <label style={{ fontSize: 11, color: C.textMuted, fontFamily: C.fontCond,
          ...
          {onMinuteChange !== undefined && (
            <input value={minute || ""} onChange={function (e) { onMinuteChange(e.target.value); }}
              ...
              style={{ width: 48, padding: "3px 6px", fontSize: 11, textAlign: "center",
  ...
  return (
    <div style={{ marginBottom: 6, borderRadius: 6, overflow: "hidden",
      ...
      <button onClick={onToggle} aria-expanded={isOpen} style={{
        ...
        <span style={{ flex: 1, fontSize: 13, fontWeight: 700, color: isOpen ? color : C.textMuted,
          fontFamily: C.fontCond, textTransform: "uppercase", letterSpacing: 1.5 }}>{title}</span>
...
function Label(_ref) {
  return <div style={{ fontSize: 11, color: C.textMuted, fontFamily: C.fontCond,
    textTransform: "uppercase", letterSpacing: 1, marginBottom: 5 }}>{_ref.children}</div>;
}
          ...
          {items.map(function (item, i) {
            return (
              <button key={i} disabled={item.disabled}
                ...
                style={{
                  width: "100%", padding: "11px 14px", fontSize: 13, fontFamily: C.fontCond,
    ...
    <div style={{ display: "flex", flexDirection: "column", height: "100%" }}>
      ...
      <div style={{
        ...
        <button onClick={onAddBoard} aria-label="Add board"
          style={{ padding: "5px 10px", fontSize: 13, background: "transparent",
            border: "1px dashed " + C.border, color: C.textDim, borderRadius: 4,
            cursor: "pointer", minHeight: 32 }}>+</button>
        <span style={{ marginLeft: "auto", fontSize: 9, color: C.textDim, fontFamily: C.fontCond,
          whiteSpace: "nowrap", paddingRight: 4 }}>Double-tap to rename</span>
      </div>
    </div>
  );
}
...
function ScoutingForm(_ref) {
  ...
  return (
    <div style={{ padding: "8px 10px 100px", overflowY: "auto" }}>
      <div style={{ padding: "10px 12px", background: C.bgCard, borderRadius: 6,
        border: "1px solid " + C.border, marginBottom: 8 }}>
        <div style={{ fontSize: 11, color: C.textMuted, fontFamily: C.fontCond,
          textTransform: "uppercase", letterSpacing: 1.5, marginBottom: 8 }}>Match Info</div>
      ...
      <Section title="Set Pieces" icon="🎯" isOpen={openSection === "setPieces"} onToggle={function () { toggle("setPieces"); }} color={C.yellow}>
        ...
        <button onClick={function () { onUpdateSetPieces(s.setPieces.concat([{ type: null, side: null, notes: "", minute: "" }])); }}
          style={{ width: "100%", padding: 10, fontSize: 12, border: "1px dashed " + C.border,
            background: "transparent", color: C.textMuted, borderRadius: 6, cursor: "pointer",
            fontFamily: C.fontCond, textTransform: "uppercase", letterSpacing: 1 }}>+ Add Set Piece</button>
      </Section>
    </div>
  );
}
      ...
      <div style={{ padding: 12, background: C.bgCard, borderRadius: 6, border: "1px solid " + C.border, marginBottom: 8 }}>
        ...
        <div style={{ display: "flex", gap: 6, marginBottom: 8 }}>
          <input value={newObsMin} onChange={function (e) { setNewObsMin(e.target.value); }}
            ...
            style={{ width: 48, padding: "8px 4px", fontSize: 13, textAlign: "center",
          ...
          <input value={newObs} onChange={function (e) { setNewObs(e.target.value); }}
            ...
            style={{ flex: 1, padding: "8px 10px", fontSize: 14, background: C.bgInput,
              border: "1px solid " + C.border, borderRadius: 4, color: C.text,
          ...
          <button onClick={addObs} aria-label="Add" style={{
            ...
            fontWeight: 700, textTransform: "uppercase" }}>Add</button>
        </div>
        ...
        {observations.slice().reverse().map(function (o) {
          return (
            <div key={o.id} style={{ display: "flex", alignItems: "flex-start", gap: 8, padding: "8px 0",
              borderBottom: "1px solid " + C.border + "22" }}>
              {o.minute && (
                <span style={{ fontSize: 12, color: C.yellow, fontFamily: C.fontCond, fontWeight: 700,
                  minWidth: 30, textAlign: "right", paddingTop: 1, flexShrink: 0 }}>{o.minute}'</span>
              )}
...
function App() {
  ...
  var deleteBoard = function (id) { setData(function (d) {
  ...
  return (
    <div style={{
      ...
      {/* Tab Bar */}
      <div style={{
        display: "flex", background: C.bgCard, borderTop: "1px solid " + C.border,
          ...
          return (
            <button key={t.id} onClick={function () { setTab(t.id); }} aria-label={t.label}
              ...
              style={{
                ...
                gap: 1, padding: "7px 0", background: "transparent", border: "none",
